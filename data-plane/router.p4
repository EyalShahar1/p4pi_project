...
const port_t BROADCAST_PORT = 9w100; // Define the appropriate broadcast value
...
control MyIngress(inout headers hdr,
    ...
    // check if broadcast port is correct
    action bcast() {
    ...
    apply {
        ...
        if (hdr.arp.isValid() || hdr.ospf.isValid()) {
        ...
        // //if (hdr.ethernet.ether_type == TYPE_ARP || hdr.ethernet.ether_type == OSPF_PROT) {
